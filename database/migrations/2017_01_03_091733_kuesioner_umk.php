...
class KuesionerUmk extends Migration
{
    ...
    public function up()
    {
        Schema::create('kuesioner_umk', function (Blueprint $table) {
            ...
            $table->string('nama_surveyor',20)->nullable();
            ...
            $table->string('i_10',1)->nullable()->comment('Apabila jabawan butir b sudah, legalitas yang dimiliki berupa');
            $table->string('i_10_a',20)->nullable()->comment('Nomor Registrasi TDP/IUI/Lainnya');
            $table->string('i_10_b',20)->nullable()->comment('Lampiran Copy TDP/IUI/Lainnya');
            $table->string('i_11',100)->nullable()->comment('Sebutkan produk yang dihasilkan oleh UMKM Saudara, dan sebutkan mana yang merupakan produk utama? ');
            $table->string('i_11_a',100)->nullable()->comment('Lampiran foto Produk');
            ...
            $table->string('i_12_a',10)->nullable()->comment('Nomor Registrasi Merk');
            ...
            $table->string('i_14',20)->nullable()->comment('Berapakah rata-rata pertahun volume produksi untuk produk utama yang Saudara');
            $table->string('i_15',20)->nullable()->comment('Berapakah rata-rata pertahun nilai produksi untuk produk utama yang Saudara hasilkan:');
            $table->string('i_16',120)->nullable()->comment('Mohon disebutkan area pemasaran untuk produk Saudara:');
            ...
            $table->string('iii_2_c',1)->nullable()->comment('');
            $table->string('iii_2_c_a',1)->nullable()->comment('');
            $table->string('iii_2_d',1)->nullable()->comment('');
            $table->string('iii_2_d_a',1)->nullable()->comment('');
            $table->string('iii_2_e',1)->nullable()->comment('');
            $table->string('iii_2_e_a',1)->nullable()->comment('');
            ...
            $table->string('iii_10_d_a',50)->nullable()->comment('');
            ...
            $table->string('iii_11_f_a',50)->nullable()->comment('');

            $table->string('iv_1',200)->comment('Masukan untuk BSN')->nullable();
